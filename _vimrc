...
set nowb
set noswapfile
"cuando un archivo cambia con otro editor lo carga utomáticamente
set autoread
"hacer más cosas con leader-key
let mapleader = ","
let g:mapleader = ","
"guardado rápido ,+w
nmap <leader>w :w!<cr>	
...
imap jj <esc>
"quita el resaltado de las búsquedas con Ctrl+l
